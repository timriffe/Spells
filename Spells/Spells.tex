...
\subsubsection{Data}
Angelo will tell us about the data and how he gets the transition probabilities and give code for a state space graph.
\subsubsection{Simulated trajectories}
We produce standard Markov transition matrices.. to be continued.
