...
pdf("DGD/Figures/Macro1.pdf")
par(mai=c(1,1,.0,0))
plot(xnew, rowMeans(dur, na.rm=TRUE), type = 'l', ylim = c(0,20), xlim = c(0,25),
		xlab = "Time since first employment exit", ylab = "Avg duration", cex.lab = 1.5,
		axes=FALSE)
axis(1);axis(2,las=1)
...
pdf("DGD/Figures/Macro3.pdf")
par(mai=c(1,1,.0,0))
plot(xnew, rowMeans(durleft, na.rm=TRUE), type = 'l', ylim = c(0,20), xlim = c(0,25), col = "blue",
		xlab = "Time since first employment exit", ylab = "Remaining time in spell", cex.lab = 1.5,
		axes=FALSE)
axis(1);axis(2,las=1)
...
pdf("DGD/Figures/Macro4.pdf")
par(mai=c(1,1,.0,0))
plot(xnew, rowMeans(durspent, na.rm=TRUE), type = 'l', ylim = c(0,20), xlim = c(0,25), col = "red",
		xlab = "Time since first employment exit", ylab = "Time spent in spell", cex.lab = 1.5,
		axes=FALSE)
axis(1);axis(2,las=1)
