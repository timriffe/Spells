...
\Large
Aanálisis de secuencias para preguntas tipo *camino-hacia-evento* pueden ser tramposos (Yaoyue Hu presentacion, 2017) .

\pause

\Large
Idea: Alinear secuencias en las transiciones. ![](idea.pdf){width=70px}

## Historia de origen

\Large
Expresión de álgebra para el número esperado de episodios (Dudel & Myrskylä, 2017-).

\pause

\Large
![](thought.pdf){width=70px} Pregunta: Realmente hay que derivar una expresión algebraica para cada cantidad posible? 
 
## Preguntas ejemplo:

\Large
> - Los episodios de discapacidad tienden a ser más largo o cortos con la edad?
> - Cual es la distribución de duraciones de otros estados antes del cáncer?
> - Cuanto de la esperanza de vida está compuesta de episodios largos o cortos?
> - Cómo varía la distribución entre partos en función de los partos anteriores? 

##  
 
\Large 
\begin{block}{\textbf{Problema}}
Las herramientas para contestar este tipo de pregunta están dispersas
\end{block}

<br>
\pause

\begin{block}{\textbf{Consequencia}}
Las preguntas nuevas y la detección de pautas nuevas son menos frecuentes
\end{block}

## 

\Large
\begin{block}{\textbf{Solucion}}
Desarrollamos una gramática de operaciones de datos para derivar pautas agregadas flexiblemente a partir de datos de trayectorias. 
\end{block}

<br>
\pause

\begin{block}{\textbf{Conceptos}}
 \textbf{Relojes} son operaciones intra y entre episodios para marcar el tiempo.\\
 \textbf{Alineación} es una operacion sobre la estructura temporal.  
\end{block}
...
\Large
\begin{block}{\textbf{Relojes}}
Dentro de episodios del estado \textbf{s}, contamos \textcolor{red}{pasos} del tiempo o el \textcolor{red}{orden} de episodios de forma \textcolor{red}{ascendiente}, \textcolor{red}{descendiente}, o de la \textcolor{red}{duracion} total del episodio en condición del momento de entrada, salido del episodio o similar.
...
\Large
\begin{block}{\textbf{Alineación}}
  \textcolor{red}{izquierda}, \textcolor{red}{derecha}, \textcolor{red}{centrado}, etc. sobre el \textcolor{blue}{primero}, \textcolor{blue}{ultimo}, \textcolor{blue}{mas largo}, \textcolor{blue}{mas corto}, \textcolor{blue}{$n^{th}$}, \textcolor{blue}{$n^{th}$ del final} episodio del estado \textbf{s}. 
\end{block}
